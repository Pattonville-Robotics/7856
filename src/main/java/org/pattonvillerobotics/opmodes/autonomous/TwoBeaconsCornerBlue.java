...
@Autonomous(name = "TwoBeaconsCornerBlue", group = OpModeGroups.MAIN)
public class TwoBeaconsCornerBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.moveInches(Direction.FORWARD, Globals.FAR_BEACON_TO_CORNER, Globals.LOW_MOTOR_POWER);
