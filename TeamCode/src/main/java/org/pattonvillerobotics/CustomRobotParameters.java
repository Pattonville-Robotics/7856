...
public class CustomRobotParameters {
    ...
    public static final RobotParameters ROBOT_PARAMETERS = new RobotParameters.Builder()
            .driveGearRatio(2)
    ...
    public static final VuforiaParameters VUFORIA_PARAMETERS = new VuforiaParameters.Builder()
