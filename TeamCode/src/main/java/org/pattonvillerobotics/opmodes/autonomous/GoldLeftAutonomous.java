...
@Autonomous (name = "GoldLeftAutonomous", group = OpModeGroups.MAIN)
public class GoldLeftAutonomous extends LinearOpMode {
...
//        drive.moveInches(Direction.FORWARD, 36, 0.5);
        drive.rotateDegrees(Direction.RIGHT, 60, 0.6);
        sleep(2000);
